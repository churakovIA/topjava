...
`curl -s -X POST -d '{"dateTime":"2015-05-30T10:00","description":"Created lunch","calories":300}' -H 'Content-Type:application/json;charset=UTF-8' http://localhost:8080/topjava/rest/profile/meals --user user@yandex.ru:password`
...
`curl -s -X POST -d '{"name":"user", "email":"user@yandex.ru", "password":"password"}' -H 'Content-Type: application/json' http://localhost:8080/topjava/rest/admin/users --user admin@gmail.com:admin`
