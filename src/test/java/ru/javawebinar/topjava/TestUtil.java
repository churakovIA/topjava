...
public class TestUtil {
    ...
    public static <T> ResultMatcher contentJson(Collection<T> expected, String ignoreProps) {
        return content().json(writeIgnoreProps(expected, ignoreProps));
    }

    public static <T> ResultMatcher contentJson(String ignoreProps, T... expected) {
